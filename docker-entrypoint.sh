...
# PhotoStudio docker entrypoint
# - prefer baked-in weights under /app/models/weights
# - prefer model cache under ${MODEL_CACHE_DIR}/weights
# - download missing weights to a .part file then move atomically
...
# U2Net (preferred baked-in at /app/models/weights)
